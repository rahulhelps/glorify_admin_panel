...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    // Exact same event as original dashboard_screen.dart:
  ...
  Widget _buildKpiGrid(BuildContext context, DashboardLoaded state) {
    final kpis = [
      ...
      _KpiData(
        ...
        count: state.pendingSubscriptions,
        icon: Icons.card_membership_rounded,
        color: AppColors.subscription,
        section: 'Subscriptions',
        isAlert: state.pendingSubscriptions > 0,
      ),
      _KpiData(
        label: 'Pending Deposits',
        count: state.pendingDeposits,
        icon: Icons.account_balance_wallet_rounded,
        color: AppColors.deposit,
        section: 'Deposits',
        isAlert: state.pendingDeposits > 0,
      ),
      _KpiData(
      ...
      _KpiData(
        label: 'Pending SMM Orders',
        count: state.pendingSmmOrders,
        icon: Icons.shopping_cart_rounded,
        color: const Color(0xFF8B5CF6),
        section: 'SMM Orders',
        isAlert: state.pendingSmmOrders > 0,
      ),
    ];
  ...
  Widget _buildQuickNavGrid(BuildContext context) {
    final tiles = [
      _QuickNavTile('Subscriptions', Icons.card_membership, AppColors.subscription, 'Subscriptions'),
      _QuickNavTile('Deposits', Icons.account_balance_wallet, AppColors.deposit, 'Deposits'),
      _QuickNavTile('Withdrawals', Icons.money_off, AppColors.withdrawal, 'Withdrawals'),
      _QuickNavTile('SMM Orders', Icons.shopping_cart, const Color(0xFF8B5CF6), 'SMM Orders'),
      _QuickNavTile('SMM Config', Icons.settings, AppColors.textSecondary, 'SMM Config'),
      ...
      _QuickNavTile('Ads Views', Icons.ondemand_video, const Color(0xFFEC4899), 'Ads Views'),
      _QuickNavTile('Ads Settings', Icons.smart_toy, const Color(0xFF6366F1), 'Ads Settings'),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: AppRadius.lgAll,
          border: Border.all(
            color: data.isAlert ? data.color.withValues(alpha: 0.4) : AppColors.border,
